class GridFloor{
	...
	createMesh(gl,incAxis){
		...
		var verts = [],
			size = 10,			// W/H of the outer box of the grid, from origin we can only go 1 unit in each direction, so from left to right is 2 units max
			div = 100.0,			// How to divide up the grid
